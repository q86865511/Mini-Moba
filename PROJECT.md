...
- 2026-06-04：完成階段 6（完整流程）。Game 改為狀態機（主選單 → 英雄選擇 → 遊玩）；主選單畫面、5 英雄選擇畫面（含立繪 + 選取高亮）；英雄死亡 5 秒後在基地重生；勝負畫面後 ENTER 回主選單。**至此 AI bot 前的基本單機 MOBA 全部完成**（階段 0–6）。下一步：階段 7 敵方英雄 AI、階段 8 多人連線。
